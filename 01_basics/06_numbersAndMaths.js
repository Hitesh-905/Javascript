...
// console.log(numberabc.toFixed(2));


//console.log(numberabc.toPrecision(2)); //100.3 -this will throw an error 
// because toPrecision is not a method of Number object, it is a method of Number prototype
...
console.log(Math.random());//tjis will return a random value between 0 and 1 on every execution
